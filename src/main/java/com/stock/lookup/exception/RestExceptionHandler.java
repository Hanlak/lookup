...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
            ...
            HttpStatus status,
            WebRequest request) {
        List<String> error = Collections.singletonList("Malformed JSON request");
    ...
    public ResponseEntity<Object> handleAllPathValidations(
        ...
        List<String> validationErrors = Collections.singletonList("path variable validation failed");
        ApiError apiError = new ApiError(BAD_REQUEST, validationErrors, exception);
        return buildResponseEntity(apiError);
    }
    ...
    public ResponseEntity<Object> handleCsvConversionException(CsvConversionException exception) {
        List<String> validationErrors = Collections.singletonList("Csv to Dto Conversion Failed");
        ApiError apiError = new ApiError(BAD_REQUEST, validationErrors, exception);
        return buildResponseEntity(apiError);
    }
}
